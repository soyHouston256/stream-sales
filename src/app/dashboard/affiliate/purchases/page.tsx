...
export default function AffiliatePurchasesPage() {
    const { t } = useLanguage();
    ...
    const { data, isLoading } = usePurchases(filters, 'affiliate');
    ...
    return (
        <div className="space-y-6">
            <div>
                <h1 className="text-3xl font-bold">{t('affiliate.purchases.title')}</h1>
                <p className="text-muted-foreground mt-2">
                    {t('affiliate.purchases.subtitle')}
                </p>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-3">
                <StatCard
                    label={t('affiliate.purchases.totalPurchases')}
                ...
                />
                <StatCard
                    label={t('affiliate.purchases.totalSpent')}
                ...
                />
                <StatCard
                    label={t('affiliate.purchases.averagePrice')}
