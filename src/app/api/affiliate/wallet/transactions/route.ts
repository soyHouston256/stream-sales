 ...
 *
 * Obtener historial de transacciones de la billetera del afiliado.
 *
 * Query params:
 ...
 *       "type": "debit",
 *       "amount": "5.00",
 *       "description": "Referral approval fee",
 *       "relatedEntityType": "Affiliation",
 *       "relatedEntityId": "affiliation_456",
...
export async function GET(request: NextRequest) {
  try {
    ...
    // An affiliate can have transactions as source or destination
    const where: any = {
      OR: [
    ...
    const data = transactions.map((tx: any) => {
      // Determine if this is a debit or credit for the affiliate
