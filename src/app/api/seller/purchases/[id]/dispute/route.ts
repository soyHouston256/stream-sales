...
/**
 * POST /api/seller/purchases/[id]/dispute
 *
 * Crea una disputa sobre una compra completada
 *
 * Body:
 * {
  ...
  try {
    ...
    if (decoded.role !== 'seller') {
      return NextResponse.json(
        { error: 'Forbidden. Only sellers can create disputes on purchases.' },
        { status: 403 }
      );
    }
    ...
    console.error('[POST /api/seller/purchases/[id]/dispute] Error:', error);
